                        ...
                        children: [
                          ...
                          ..._controller.filteredJenisBarang.asMap().entries.map((entry) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                Get.to(() => JenisBarangDetailPage(), arguments: jenisBarang.id);
                              },
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Semantics(
                                    label: 'Item Type ${jenisBarang.name}',
                                    child: Row(
                                      children: [
                                        CircleAvatar(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                jenisBarang.description ?? 'No description',
                                                style: TextStyle(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Manage your item types with ease',
                    style: TextStyle(
